				...
				<?php
					...
					if (mysqli_affected_rows($con) != 0) {
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					         ...
					         $msgid = $row['numQueja'];
					        echo "<td>" . $row['numQueja'] . "</td>";
					        echo "<td>" . $row['tipo'] . "</td>";
					        echo "<td>" . $row['descripcion'] . "</td>";
					        echo "<td>" . $row['cliente'] . "</td>";
					        echo "<td>" . $row['novedad'] . "</td>";

					         echo "<td><form action='edit_Queja.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/>  <center> <input type='submit' value='Añadir Novedad ' class='btn btn-info' style='width:130px; height:30px' /> </center>  </form></td></tr>";
