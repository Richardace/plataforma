				...
				<?php
					...
					if (mysqli_affected_rows($con) != 0) {
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					        ...
					        echo "<td>" . $row['codOficio'] . "</td>";
					        echo "<td>" . $row['descripcion'] . "</td>";
					        
					        
					        $sno++;
					        
					        echo "<td><form action='edit_Oficio.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/>  <center> <input type='submit' value='Editar Oficio' class='btn btn-info' style='width:130px; height:30px' /> </center>  </form></td></tr>";
					        $msgid = 0;
					    }
