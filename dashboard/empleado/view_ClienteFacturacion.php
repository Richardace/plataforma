				...
				<?php
					...
					if (mysqli_affected_rows($con) != 0) {
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					        ...
					        echo "<td><form action='addFactura.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Añadir Factura ' class='btn btn-info'/></form></td></tr>";
					        $msgid = 0;
					    }
