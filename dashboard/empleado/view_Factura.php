    ...
    <body class="page-body  page-fade">
		...
		<div class="sidebar-menu">
    		...
    		<div class="main-content">
				...
				<tbody>
				<?php
					$query  = "select * from factura_plan";
					//echo $query;
					...
					if (mysqli_affected_rows($con) != 0) {
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					        ...
					        echo "<td><form action='edit_Factura.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Añadir Novedad ' class='btn btn-info'/></form></td></tr>";
					        $msgid = 0;
					    }
