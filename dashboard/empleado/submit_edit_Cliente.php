...
if (isset($_POST['name'])) {
    ...
    mysqli_query($con, "UPDATE cliente SET name='$name', apellido='$apellido', pass_key='$pass_key', level='$level', sex='$sex', correo='$correo', telefono='$telefono'WHERE login_id='$login_id'");
