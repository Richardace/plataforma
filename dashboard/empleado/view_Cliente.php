				...
				<?php
					...
					if (mysqli_affected_rows($con) != 0) {
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					        ...
					        echo "<td><form action='edit_Cliente.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/>  <center> <input type='submit' value='Editar Cliente' class='btn btn-info' style='width:130px; height:30px' /> </center>  </form></td></tr>";
					        $msgid = 0;
					    }
