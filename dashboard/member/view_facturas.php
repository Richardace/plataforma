    ...
    <body class="page-body  page-fade">
		...
		<table class="table table-bordered datatable" id="table-1">
			<thead>
				...
				<?php
					$query  = "select * from factura_plan where cliente = '$add' and estado='no pagado'";
					//echo $query;
					...
					if (mysqli_affected_rows($con) != 0) {
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					        ...
					        echo "<td>" . $row['estado'] . "</td>";
					                ...
					                echo "<td><form action='make_payments.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Añadir Pago ' class='btn btn-info'/></form></td></tr>";
					                $msgid = 0;
					    }
					}
